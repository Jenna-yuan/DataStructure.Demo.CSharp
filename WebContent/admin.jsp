...
${msg}
	<form id="loginform" action="admin" method="post">
		<table style="border:0;cellpadding:4;" class="loginTable">
			...
			<tr>
				<td>密码：
				<input id="password" name="password" style="width: 200px;height: 25px;top: 200px;left: 250px; border-bottom-right-radius: 20px;  border-bottom-left-radius: 20px;    border-top-left-radius: 20px;    border-top-right-radius: 20px;" />
				</td>
			</tr>
			<tr>
				<td>
